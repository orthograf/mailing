...
return array(
    ...
    'ml_activation_confirm' => 'Вы уверены в том, что хотите запустить рассылку?',
    'ml_deactivation_confirm' => 'Вы уверены в том, что хотите остановить рассылку?',
    'ml_yes' => 'Да',
    'ml_no' => 'Нет',
    'ml_cancel' => 'Отменить',
    'ml_save' => 'Сохранить',
    ...
    'unsub_notice' => '<p><a href="' . Config::Get('path.root.url') . '/mailing/unsubscribe?email=%%email%%&hash=%%hash%%">Если Вы не хотите получать эти уведомления, нажмите на эту ссылку</a></p>',
);
